  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12">
      <div className="space-y-16">
        {CONCOURS_LIST.map((concours, ci) => {
          const grouped = concours.postes.reduce<Record<string, typeof concours.postes>>((acc, p) => {
          ...
          return (
            <article key={concours.slug}>
              <div className={`card animate-fade-in-up mb-10 border-t-2 border-t-gold-500 p-6 sm:p-8${ci > 0 ? " mt-16" : ""}`}>
              ...
              <section className="mb-10 grid gap-6 sm:grid-cols-2">
                <div className="card card-hover animate-fade-in-up stagger-1 p-5">
                  ...
                  <ul className="space-y-2 text-sm text-ink-soft">
                    <li>
                      <strong className="text-ink">{t("examDatesLabel")}</strong> {concours.examDatesValue[locale]}
                    </li>
                    <li>
              ...
              {concours.ecoles && concours.ecoles.length > 0 && (
      ...
      <section className="animate-fade-in-up mt-16 rounded-2xl border border-gold-500/40 bg-gold-50 p-5 sm:p-6">
